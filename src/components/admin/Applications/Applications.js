...
import { getRequestApplications, getHistoryApplications } from '../../../actions'
          ...
          <div className="table-reports report-investors">
            ...
            <div className="settings-body settings-body-desktop">
              <PerfectScrollbar className={'edit-admins-desktop'}>
                <table className={'settings-table reports-table applications-table'}>
                  <tbody>
                    <tr>
            ...
            <div className="setting-footer">
              <button className={'save-applies settings-save'}>Сохранить одобрения</button>
            </div>
          </div>
        </div>
        <div className={'admin-block'}>
              ...
              <PerfectScrollbar className={'edit-admins-desktop'}>
                <table className={'settings-table reports-table applications-table'}>
                  <tbody>
                    ...
                    {this.props.historyApplicationsIsLoading && <ReportsLoader />}
